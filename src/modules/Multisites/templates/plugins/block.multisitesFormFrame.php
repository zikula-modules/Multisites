...
/**
 * The multisitesFormFrame plugin adds styling <div> elements and a validation summary.
 *
 ...
 */
function smarty_block_multisitesFormFrame($params, $content, $view)
{
    ...
    $result .= $view->registerBlock('Multisites_Form_Plugin_FormFrame', $params, $content);
