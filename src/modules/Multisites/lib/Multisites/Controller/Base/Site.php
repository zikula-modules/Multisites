 ...
 */
class Multisites_Controller_Base_Site extends Zikula_AbstractController
{
    /**
     * Post initialise.
     *
    ...
    public function view()
    {
        ...
        $objectType = 'site';
        $utilArgs = array('controller' => 'site', 'action' => 'view');
        ...
        $currentUrlObject = new Zikula_ModUrl($this->name, 'site', 'view', ZLanguage::getLanguageCode(), $currentUrlArgs);
    ...
    public function edit()
    {
        ...
        // parameter specifying which type of objects we are treating
        $objectType = 'site';
        $utilArgs = array('controller' => 'site', 'action' => 'edit');
        ...
        $handlerClass = $this->name . '_Form_Handler_Site_Edit';
    ...
    public function delete()
    {
        ...
        // parameter specifying which type of objects we are treating
        $objectType = 'site';
        $utilArgs = array('controller' => 'site', 'action' => 'delete');
        ...
        if (!$deleteAllowed) {
            return LogUtil::registerError($this->__('Error! It is not allowed to delete this site.'));
        }
        ...
        if ($confirmation && $deleteAllowed) {
            ...
            if (!$validators->hasErrors()) {
                ...
                // Let any hooks know that we have created, updated or deleted the site
                $hookType = 'process_delete';
                $hook = new Zikula_ProcessHook($hookAreaPrefix . '.' . $hookType, $entity->createCompositeIdentifier());
                $this->notifyHooks($hook);
        
                // The site was deleted, so we clear all cached pages this item.
                $cacheArgs = array('ot' => $objectType, 'item' => $entity);
                ModUtil::apiFunc($this->name, 'cache', 'clearItemCache', $cacheArgs);
        
                // redirect to the list of sites
                $redirectUrl = ModUtil::url($this->name, 'site', 'view', array('lct' => $legacyControllerType));
    ...
    public function manageExtensions()
    {
        ...
        // parameter specifying which type of objects we are treating
        $objectType = 'site';
        $utilArgs = array('controller' => 'site', 'action' => 'manageExtensions');
    ...
    public function manageThemes()
    {
        ...
        // parameter specifying which type of objects we are treating
        $objectType = 'site';
        $utilArgs = array('controller' => 'site', 'action' => 'manageThemes');
        $permLevel = $legacyControllerType == 'admin' ? ACCESS_ADMIN : ACCESS_OVERVIEW;
        $this->throwForbiddenUnless(SecurityUtil::checkPermission($this->name . ':' . ucfirst($objectType) . ':', '::', $permLevel), LogUtil::getErrorMsgPermission());
        /** TODO: custom logic */
    ...
    public function setThemeAsDefault()
    {
        ...
        // parameter specifying which type of objects we are treating
        $objectType = 'site';
        $utilArgs = array('controller' => 'site', 'action' => 'setThemeAsDefault');
        $permLevel = $legacyControllerType == 'admin' ? ACCESS_ADMIN : ACCESS_OVERVIEW;
        $this->throwForbiddenUnless(SecurityUtil::checkPermission($this->name . ':' . ucfirst($objectType) . ':', '::', $permLevel), LogUtil::getErrorMsgPermission());
        /** TODO: custom logic */
        
        // return template
        return $this->view->fetch('site/setThemeAsDefault.tpl');
    }
    ...
    public function viewTools()
    {
        ...
        // parameter specifying which type of objects we are treating
        $objectType = 'site';
        $utilArgs = array('controller' => 'site', 'action' => 'viewTools');
        $permLevel = $legacyControllerType == 'admin' ? ACCESS_ADMIN : ACCESS_OVERVIEW;
        $this->throwForbiddenUnless(SecurityUtil::checkPermission($this->name . ':' . ucfirst($objectType) . ':', '::', $permLevel), LogUtil::getErrorMsgPermission());
        /** TODO: custom logic */
    ...
    public function executeTool()
    {
        ...
        // parameter specifying which type of objects we are treating
        $objectType = 'site';
        $utilArgs = array('controller' => 'site', 'action' => 'executeTool');
        $permLevel = $legacyControllerType == 'admin' ? ACCESS_ADMIN : ACCESS_OVERVIEW;
        $this->throwForbiddenUnless(SecurityUtil::checkPermission($this->name . ':' . ucfirst($objectType) . ':', '::', $permLevel), LogUtil::getErrorMsgPermission());
        /** TODO: custom logic */
        
        // return template
        return $this->view->fetch('site/executeTool.tpl');
    }
    ...
    public function exportDatabaseAsTemplate()
    {
        ...
        // parameter specifying which type of objects we are treating
        $objectType = 'site';
        $utilArgs = array('controller' => 'site', 'action' => 'exportDatabaseAsTemplate');
        $permLevel = $legacyControllerType == 'admin' ? ACCESS_ADMIN : ACCESS_OVERVIEW;
        $this->throwForbiddenUnless(SecurityUtil::checkPermission($this->name . ':' . ucfirst($objectType) . ':', '::', $permLevel), LogUtil::getErrorMsgPermission());
        /** TODO: custom logic */
        
        // return template
        return $this->view->fetch('site/exportDatabaseAsTemplate.tpl');
    }
    ...
    public function handleSelectedEntries()
    {
        ...
        foreach ($items as $itemid) {
            ...
            if ($action != 'delete') {
                ...
                $url = new Zikula_ModUrl($this->name, 'site', 'display', ZLanguage::getLanguageCode(), $urlArgs);
            }
    ...
    public function handleInlineRedirect()
    {
        ...
        $this->view->display('site/inlineRedirectHandler.tpl');
