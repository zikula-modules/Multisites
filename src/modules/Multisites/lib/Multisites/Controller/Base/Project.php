 ...
 */
class Multisites_Controller_Base_Project extends Zikula_AbstractController
{
    /**
     * Post initialise.
     *
    ...
    public function view()
    {
        ...
        $objectType = 'project';
        $utilArgs = array('controller' => 'project', 'action' => 'view');
        ...
        $currentUrlObject = new Zikula_ModUrl($this->name, 'project', 'view', ZLanguage::getLanguageCode(), $currentUrlArgs);
    ...
    public function edit()
    {
        ...
        // parameter specifying which type of objects we are treating
        $objectType = 'project';
        $utilArgs = array('controller' => 'project', 'action' => 'edit');
        ...
        $handlerClass = $this->name . '_Form_Handler_Project_Edit';
    ...
    public function handleSelectedEntries()
    {
        ...
        $redirectUrl = ModUtil::url($this->name, 'admin', 'main', array('ot' => 'project'));
        ...
        foreach ($items as $itemid) {
            ...
            if ($action != 'delete') {
                ...
                $url = new Zikula_ModUrl($this->name, 'project', 'display', ZLanguage::getLanguageCode(), $urlArgs);
            }
    ...
    public function handleInlineRedirect()
    {
        ...
        $this->view->display('project/inlineRedirectHandler.tpl');
