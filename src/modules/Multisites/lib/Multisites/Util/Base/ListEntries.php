 ...
 */
class Multisites_Util_Base_ListEntries extends Zikula_AbstractBase
{
    /**
    ...
    {
        $states = array();
        $states[] = array('value'   => 'module',
                          'text'    => $this->__('Module'),
                          'title'   => '',
                          'image'   => '',
                          'default' => true);
        $states[] = array('value'   => 'theme',
                          'text'    => $this->__('Theme'),
                          'title'   => '',
                          'image'   => '',
                          'default' => false);
        $states[] = array('value'   => 'systemPlugin',
                          'text'    => $this->__('System plugin'),
                          'title'   => '',
                          'image'   => '',
                          'default' => false);
        $states[] = array('value'   => 'modulePlugin',
