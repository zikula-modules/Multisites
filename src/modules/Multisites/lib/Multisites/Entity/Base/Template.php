 ...
 * @abstract
 */
abstract class Multisites_Entity_Base_Template extends Zikula_EntityAccess
{
    /**
    ...
    /**
     * @var Multisites_Entity_Validator_Template The validator for this entity.
     */
     ...
     *
     * @ORM\ManyToMany(targetEntity="Multisites_Entity_Project", mappedBy="templates")
     * @var Multisites_Entity_Project[] $projects.
     */
    protected $projects = null;
    /**
     * Bidirectional - One template [template] has many sites [sites] (INVERSE SIDE).
     *
     * @ORM\OneToMany(targetEntity="Multisites_Entity_Site", mappedBy="template", cascade={"remove"})
     * @ORM\JoinTable(name="multisites_templatesites")
     ...
     * Get _validator.
     *
     * @return Multisites_Entity_Validator_Template
     */
     ...
     * Set _validator.
     *
     * @param Multisites_Entity_Validator_Template $_validator.
     *
     * @return void
     */
    public function set_validator(Multisites_Entity_Validator_Template $_validator = null)
    {
     ...
     * @return void
     */
    public function setSqlFileMeta($sqlFileMeta = Array())
    {
     ...
     * Set projects.
     *
     * @param Multisites_Entity_Project[] $projects.
     *
     * @return void
     */
    ...
    /**
     * Adds an instance of Multisites_Entity_Project to the list of projects.
     *
     * @param Multisites_Entity_Project $project The instance to be added to the collection.
     *
     * @return void
     */
    public function addProjects(Multisites_Entity_Project $project)
    {
    ...
    /**
     * Removes an instance of Multisites_Entity_Project from the list of projects.
     *
     * @param Multisites_Entity_Project $project The instance to be removed from the collection.
     *
     * @return void
     */
    public function removeProjects(Multisites_Entity_Project $project)
    {
     ...
     *
     * @see Multisites_Entity_Template::postLoadCallback()
    ...
    protected function performPostLoadCallback()
    {
        ...
        $this['parameters'] = ((isset($this['parameters']) && is_array($this['parameters'])) ? DataUtil::formatForDisplay($this['parameters']) : array());
        $this['folders'] = ((isset($this['folders']) && is_array($this['folders'])) ? DataUtil::formatForDisplay($this['folders']) : array());
        $this['excludedTables'] = ((isset($this['excludedTables']) && is_array($this['excludedTables'])) ? DataUtil::formatForDisplay($this['excludedTables']) : array());
     ...
     *
     * @see Multisites_Entity_Template::prePersistCallback()
     * @return boolean true if completed successfully else false.
     */
     ...
     *     - no access to entity manager or unit of work apis
     *
     * @see Multisites_Entity_Template::postPersistCallback()
     * @return boolean true if completed successfully else false.
     */
     ...
     *
     * @see Multisites_Entity_Template::preRemoveCallback()
     * @return boolean true if completed successfully else false.
     */
     ...
     *     - will not be called for a DQL DELETE statement
     *
     * @see Multisites_Entity_Template::postRemoveCallback()
     * @return boolean true if completed successfully else false.
     */
     ...
     *     - no creation of other entities allowed
     *
     * @see Multisites_Entity_Template::preUpdateCallback()
     * @return boolean true if completed successfully else false.
     */
     ...
     *     - will not be called for a DQL UPDATE statement
     *
     * @see Multisites_Entity_Template::postUpdateCallback()
     * @return boolean true if completed successfully else false.
     */
     ...
     *
     * @see Multisites_Entity_Template::preSaveCallback()
     * @return boolean true if completed successfully else false.
     */
     ...
     * For more information see corresponding callback handlers.
     *
     * @see Multisites_Entity_Template::postSaveCallback()
     * @return boolean true if completed successfully else false.
     */
     ...
     *
     * @return Multisites_Entity_Validator_Template The validator for this entity.
     */
    public function initValidator()
    {
        ...
        $this->_validator = new Multisites_Entity_Validator_Template($this);
    ...
    protected function prepareItemActions()
    {
        ...
        if ($currentLegacyControllerType == 'admin') {
            ...
            if (in_array($currentFunc, array('main', 'view', 'display'))) {
                $component = 'Multisites:Template:';
                $instance = $this->id . '::';
                if (SecurityUtil::checkPermission($component, $instance, ACCESS_EDIT)) {
                    $this->_actions[] = array(
                        'url' => array('type' => 'admin', 'func' => 'edit', 'arguments' => array('ot' => 'template', 'id' => $this['id'])),
                        'icon' => 'edit',
                        'linkTitle' => __('Edit', $dom),
                        'linkText' => __('Edit', $dom)
                    );
                    $this->_actions[] = array(
                        'url' => array('type' => 'admin', 'func' => 'edit', 'arguments' => array('ot' => 'template', 'astemplate' => $this['id'])),
                        'icon' => 'saveas',
            ...
            if ($authAdmin || (isset($uid) && isset($this->createdUserId) && $this->createdUserId == $uid)) {
                ...
                $this->_actions[] = array(
                    'url' => array('type' => 'admin', 'func' => 'edit', 'arguments' => $urlArgs),
                    'icon' => 'add',
                    'linkTitle' => __('Create project', $dom),
                    'linkText' => __('Create project', $dom)
                );
            }
        }
    }
    ...
    {
        return 'multisites.ui_hooks.templates';
    }
