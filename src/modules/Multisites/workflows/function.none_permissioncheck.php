 ...
 */
function Multisites_workflow_none_permissioncheck($obj, $permLevel, $currentUser, $actionId)
{
    ...
    $idFields = ModUtil::apiFunc('Multisites', 'selection', 'getIdFields', array('ot' => $objectType));
    $instanceId = '';
 ...
 */
function Multisites_workflow_none_gettextstrings()
{
    return array(
