...
function ZikulaMultisitesModule_operation_update(&$entity, $params)
{
    ...
    try {
        ...
        //});
        $result = true;
        $logger->notice('{app}: User {user} updated an entity.', ['app' => 'ZikulaMultisitesModule', 'user' => \UserUtil::getVar('uname')]);
    } catch (\Exception $e) {
        $logger->error('{app}: User {user} tried to update an entity, but failed.', ['app' => 'ZikulaMultisitesModule', 'user' => \UserUtil::getVar('uname')]);
