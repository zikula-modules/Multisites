...
abstract class AbstractViewHelper
{
    ...
    {
        $extensions = [];
        $hasAdminAccess = $this->permissionApi->hasPermission('ZikulaMultisitesModule:' . ucfirst($type) . ':', '::', ACCESS_ADMIN);
        if ($func == 'view') {
            if ($hasAdminAccess) {
    ...
    protected function processPdf(array $templateParameters = [], $template)
    {
        ...
        $output = $this->twig->render('@ZikulaMultisitesModule/includePdfHeader.html.twig') . $output . '</body></html>';
