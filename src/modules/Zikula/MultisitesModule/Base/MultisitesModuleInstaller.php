...
class MultisitesModuleInstaller extends AbstractExtensionInstaller
{
    ...
    public function install()
    {
        ...
        try {
            ...
            $returnMessage = $this->__f('An error was encountered while creating the tables for the %s extension.', ['%s' => 'ZikulaMultisitesModule']);
            if (!System::isDevelopmentMode()) {
    ...
    */
    ...
    public function uninstall()
    {
        ...
        try {
            ...
            $this->addFlash('error', $this->__f('An error was encountered while dropping tables for the %s extension.', ['%s' => 'ZikulaMultisitesModule']));
            $logger->error('{app}: Could not remove the database tables during uninstallation. Error details: {errorMessage}.', ['app' => 'ZikulaMultisitesModule', 'errorMessage' => $e->getMessage()]);
