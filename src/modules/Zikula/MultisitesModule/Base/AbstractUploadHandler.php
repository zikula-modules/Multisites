...
abstract class AbstractUploadHandler
{
    ...
    public function performFileUpload($objectType, $fileData, $fieldName)
    {
        ...
        if ($isImage) {
            ...
            if (\ModUtil::getVar('ZikulaMultisitesModule', 'enableShrinkingFor' . $fieldSuffix, false) == true) {
                // resize to allowed maximum size
                $thumbManager = $serviceManager->get('systemplugin.imagine.manager');
                $maxWidth = \ModUtil::getVar('ZikulaMultisitesModule', 'shrinkWidth' . $fieldSuffix, 800);
                $maxHeight = \ModUtil::getVar('ZikulaMultisitesModule', 'shrinkHeight' . $fieldSuffix, 600);
