...
use Zikula\MultisitesModule\Listener\Base\UserLoginListener as BaseUserLoginListener;
...
class UserLoginListener extends BaseUserLoginListener
{
     ...
     * by calling `$session->set()` prior to the redirect, as follows:
     *
     *     $serviceManager = ServiceUtil::getManager();
     *     $session = $serviceManager->get('session');
     ...
     * `Users\Controller\UserController#login()` function can be called with the appropriate parameters, if the event is desired.
     *
     * @param GenericEvent $event The event instance.
     */
