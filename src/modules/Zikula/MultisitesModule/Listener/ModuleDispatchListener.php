...
use Zikula\MultisitesModule\Listener\Base\ModuleDispatchListener as BaseModuleDispatchListener;
...
class ModuleDispatchListener extends BaseModuleDispatchListener
{
    ...
    public function serviceLinks(GenericEvent $event)
    {
        ...
        // $event->data[] = ['url' => $serviceManager->get('router')->generate('zikulamultisitesmodule_user_index'), 'text' => $serviceManager->get('translator.default')->__('Link text')];
