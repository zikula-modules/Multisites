...
abstract class AbstractEntityLifecycleListener implements EventSubscriber
{
    ...
    public function preRemove(LifecycleEventArgs $args)
    {
        ...
        $dispatcher->dispatch(constant('\\Zikula\\MultisitesModule\\MultisitesEvents::' . strtoupper($entity->get_objectType()) . '_PRE_REMOVE'), $event);
    ...
    public function postRemove(LifecycleEventArgs $args)
    {
        ...
        $logArgs = ['app' => 'ZikulaMultisitesModule', 'user' => $serviceManager->get('zikula_users_module.current_user')->get('uname'), 'entity' => $objectType, 'id' => $objectId];
        $logger->debug('{app}: User {user} removed the {entity} with id {id}.', $logArgs);
        
        $dispatcher = $serviceManager->get('event_dispatcher');
        
        // create the filter event and dispatch it
        $filterEventClass = '\\Zikula\\MultisitesModule\\Event\\Filter' . ucfirst($objectType) . 'Event';
        $event = new $filterEventClass($entity);
        $dispatcher->dispatch(constant('\\Zikula\\MultisitesModule\\MultisitesEvents::' . strtoupper($objectType) . '_POST_REMOVE'), $event);
    }
    ...
    public function prePersist(LifecycleEventArgs $args)
    {
        ...
        $filterEventClass = '\\Zikula\\MultisitesModule\\Event\\Filter' . ucfirst($entity->get_objectType()) . 'Event';
        $event = new $filterEventClass($entity);
        $dispatcher->dispatch(constant('\\Zikula\\MultisitesModule\\MultisitesEvents::' . strtoupper($entity->get_objectType()) . '_PRE_PERSIST'), $event);
        if ($event->isPropagationStopped()) {
            return false;
        }
    }
    ...
    public function postPersist(LifecycleEventArgs $args)
    {
        ...
        $objectId = $entity->createCompositeIdentifier();
        $logger = $serviceManager->get('logger');
        $logArgs = ['app' => 'ZikulaMultisitesModule', 'user' => $serviceManager->get('zikula_users_module.current_user')->get('uname'), 'entity' => $entity->get_objectType(), 'id' => $objectId];
        ...
        $filterEventClass = '\\Zikula\\MultisitesModule\\Event\\Filter' . ucfirst($entity->get_objectType()) . 'Event';
        $event = new $filterEventClass($entity);
        $dispatcher->dispatch(constant('\\Zikula\\MultisitesModule\\MultisitesEvents::' . strtoupper($entity->get_objectType()) . '_POST_PERSIST'), $event);
    }
    ...
    public function preUpdate(PreUpdateEventArgs $args)
    {
        ...
        $filterEventClass = '\\Zikula\\MultisitesModule\\Event\\Filter' . ucfirst($entity->get_objectType()) . 'Event';
        $event = new $filterEventClass($entity);
        $dispatcher->dispatch(constant('\\Zikula\\MultisitesModule\\MultisitesEvents::' . strtoupper($entity->get_objectType()) . '_PRE_UPDATE'), $event);
        if ($event->isPropagationStopped()) {
            return false;
        }
    }
    ...
    public function postUpdate(LifecycleEventArgs $args)
    {
        ...
        $filterEventClass = '\\Zikula\\MultisitesModule\\Event\\Filter' . ucfirst($entity->get_objectType()) . 'Event';
        $event = new $filterEventClass($entity);
        $dispatcher->dispatch(constant('\\Zikula\\MultisitesModule\\MultisitesEvents::' . strtoupper($entity->get_objectType()) . '_POST_UPDATE'), $event);
    }
    ...
    public function postLoad(LifecycleEventArgs $args)
    {
        ...
        $objectType = $entity->get_objectType();
        $controllerHelper = ServiceUtil::get('zikula_multisites_module.controller_helper');
        ...
        $filterEventClass = '\\Zikula\\MultisitesModule\\Event\\Filter' . ucfirst($entity->get_objectType()) . 'Event';
        $event = new $filterEventClass($entity);
        $dispatcher->dispatch(constant('\\Zikula\\MultisitesModule\\MultisitesEvents::' . strtoupper($entity->get_objectType()) . '_POST_LOAD'), $event);
    }
