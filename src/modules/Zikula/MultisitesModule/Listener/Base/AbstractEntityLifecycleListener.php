...
abstract class AbstractEntityLifecycleListener implements EventSubscriber
{
    ...
    public function preRemove(LifecycleEventArgs $args)
    {
        ...
        $dispatcher->dispatch(constant('ZikulaMultisitesModuleEvents::' . strtoupper($entity->get_objectType()) . '_PRE_REMOVE'), $event);
    ...
    public function postRemove(LifecycleEventArgs $args)
    {
        ...
        foreach ($uploadFields as $uploadField) {
            ...
            $uploadManager->deleteUploadFile('multisites', $entity, $uploadField, $objectId);
        }
        ...
        $event = new $filterEventClass($entity);
        $dispatcher->dispatch(constant('ZikulaMultisitesModuleEvents::' . strtoupper($objectType) . '_POST_REMOVE'), $event);
    }
    ...
    public function prePersist(LifecycleEventArgs $args)
    {
        ...
        $filterEventClass = 'Filter' . ucfirst($entity->get_objectType()) . 'Event';
        $event = new $filterEventClass($entity);
        $dispatcher->dispatch(constant('ZikulaMultisitesModuleEvents::' . strtoupper($entity->get_objectType()) . '_PRE_PERSIST'), $event);
        if ($event->isPropagationStopped()) {
            return false;
        }
    }
    ...
    public function postPersist(LifecycleEventArgs $args)
    {
        ...
        $filterEventClass = 'Filter' . ucfirst($entity->get_objectType()) . 'Event';
        $event = new $filterEventClass($entity);
        $dispatcher->dispatch(constant('ZikulaMultisitesModuleEvents::' . strtoupper($entity->get_objectType()) . '_POST_PERSIST'), $event);
    }
    ...
    public function preUpdate(PreUpdateEventArgs $args)
    {
        ...
        $filterEventClass = 'Filter' . ucfirst($entity->get_objectType()) . 'Event';
        $event = new $filterEventClass($entity);
        $dispatcher->dispatch(constant('ZikulaMultisitesModuleEvents::' . strtoupper($entity->get_objectType()) . '_PRE_UPDATE'), $event);
        if ($event->isPropagationStopped()) {
            return false;
        }
    }
    ...
    public function postUpdate(LifecycleEventArgs $args)
    {
        ...
        $filterEventClass = 'Filter' . ucfirst($entity->get_objectType()) . 'Event';
        $event = new $filterEventClass($entity);
        $dispatcher->dispatch(constant('ZikulaMultisitesModuleEvents::' . strtoupper($entity->get_objectType()) . '_POST_UPDATE'), $event);
    }
    ...
    public function postLoad(LifecycleEventArgs $args)
    {
        ...
        $filterEventClass = 'Filter' . ucfirst($entity->get_objectType()) . 'Event';
        $event = new $filterEventClass($entity);
        $dispatcher->dispatch(constant('ZikulaMultisitesModuleEvents::' . strtoupper($entity->get_objectType()) . '_POST_LOAD'), $event);
    ...
    protected function isEntityManagedByThisBundle($entity)
    {
        ...
        return ($entityClassParts[0] == 'Zikula' && $entityClassParts[1] == 'Multisites');
    }
}
