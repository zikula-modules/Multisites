...
class Site extends EntityRepository
{
    ...
    public function truncateTable()
    {
        ...
        $logger->debug('{app}: User {user} truncated the {entity} entity table.', ['app' => 'ZikulaMultisitesModule', 'user' => UserUtil::getVar('uname'), 'entity' => 'site']);
    }
    /**
    ...
    public function updateCreator($userId, $newUserId)
    {
        ...
        $logger = $serviceManager->get('logger');
        $logger->debug('{app}: User {user} updated {entities} created by user id {userid}.', ['app' => 'ZikulaMultisitesModule', 'user' => UserUtil::getVar('uname'), 'entities' => 'sites', 'userid' => $userId]);
    }
    ...
    public function updateLastEditor($userId, $newUserId)
    {
        ...
        $logger = $serviceManager->get('logger');
        $logger->debug('{app}: User {user} updated {entities} edited by user id {userid}.', ['app' => 'ZikulaMultisitesModule', 'user' => UserUtil::getVar('uname'), 'entities' => 'sites', 'userid' => $userId]);
    }
    ...
    public function deleteByCreator($userId)
    {
        ...
        $logger = $serviceManager->get('logger');
        $logger->debug('{app}: User {user} deleted {entities} created by user id {userid}.', ['app' => 'ZikulaMultisitesModule', 'user' => UserUtil::getVar('uname'), 'entities' => 'sites', 'userid' => $userId]);
    }
    ...
    public function deleteByLastEditor($userId)
    {
        ...
        $logger = $serviceManager->get('logger');
        $logger->debug('{app}: User {user} deleted {entities} edited by user id {userid}.', ['app' => 'ZikulaMultisitesModule', 'user' => UserUtil::getVar('uname'), 'entities' => 'sites', 'userid' => $userId]);
    }
    ...
    public function addCommonViewFilters(QueryBuilder $qb)
    {
        ...
        foreach ($parameters as $k => $v) {
            if ($k == 'catId') {
                 ...
                 */
                $qb = ModUtil::apiFunc('ZikulaMultisitesModule', 'category', 'buildFilterClauses', ['qb' => $qb, 'ot' => 'site', 'catids' => $v]);
