 ...
 */
abstract class AbstractSiteRepository extends EntityRepository
{
    /**
    ...
    public function getAdditionalTemplateParameters(ImageHelper $imageHelper, $context = '', $args = [])
    {
        ...
        if ($context == 'controllerAction') {
            ...
            $objectType = 'site';
            $thumbRuntimeOptions = [];
            $thumbRuntimeOptions[$objectType . 'Logo'] = $imageHelper->getRuntimeOptions($objectType, 'logo', $context, $args);
            $thumbRuntimeOptions[$objectType . 'FavIcon'] = $imageHelper->getRuntimeOptions($objectType, 'favIcon', $context, $args);
            $thumbRuntimeOptions[$objectType . 'ParametersCsvFile'] = $imageHelper->getRuntimeOptions($objectType, 'parametersCsvFile', $context, $args);
