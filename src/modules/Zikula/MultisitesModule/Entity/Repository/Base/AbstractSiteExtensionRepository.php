...
abstract class AbstractSiteExtensionRepository extends EntityRepository
{
     ...
     */
    protected $mainEntityClass = 'Zikula\MultisitesModule\Entity\SiteExtensionEntity';
    ...
    public function getListQueryBuilder($where = '', $orderBy = '', $useJoins = true, $slimMode = false)
    {
        ...
        if ((!$useJoins || !$slimMode) && null !== $this->collectionFilterHelper) {
            $qb = $this->collectionFilterHelper->addCommonViewFilters('siteExtension', $qb);
        }
    ...
    public function selectSearch($fragment = '', $exclude = [], $orderBy = '', $currentPage = 1, $resultsPerPage = 25, $useJoins = true)
    {
        ...
        if (null !== $this->collectionFilterHelper) {
            $qb = $this->collectionFilterHelper->addSearchFilter('siteExtension', $qb, $fragment);
        }
    ...
    public function selectCount($where = '', $useJoins = false, $parameters = [])
    {
        ...
        if (null !== $this->collectionFilterHelper) {
            $qb = $this->collectionFilterHelper->applyDefaultFilters('siteExtension', $qb, $parameters);
        }
     ...
     * @param integer $excludeId  Id of site extensions to exclude (optional)
     *
