 ...
 */
abstract class AbstractSiteExtensionRepository extends EntityRepository
{
    ...
    public function getAdditionalTemplateParameters(ImageHelper $imageHelper, $context = '', $args = [])
    {
        ...
        if ($context == 'controllerAction') {
            ...
            if (in_array($args['action'], ['display', 'view'])) {
                ...
                $templateParameters['relationThumbRuntimeOptions'] = $imageHelper->getCustomRuntimeOptions('', '', 'ZikulaMultisitesModule_relateditem', $context, $args);
            }
        }
