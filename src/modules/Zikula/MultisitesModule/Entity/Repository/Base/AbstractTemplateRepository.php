 ...
 */
abstract class AbstractTemplateRepository extends EntityRepository
{
    ...
    public function getAdditionalTemplateParameters(ImageHelper $imageHelper, $context = '', $args = [])
    {
        ...
        if ($context == 'controllerAction') {
            ...
            $objectType = 'template';
            $thumbRuntimeOptions = [];
            $thumbRuntimeOptions[$objectType . 'SqlFile'] = $imageHelper->getRuntimeOptions($objectType, 'sqlFile', $context, $args);
    ...
    public function truncateTable(LoggerInterface $logger)
    {
        ...
        $logArgs = ['app' => 'ZikulaMultisitesModule', 'entity' => 'template'];
    ...
    public function updateCreator($userId, $newUserId, TranslatorInterface $translator, LoggerInterface $logger, CurrentUserApi $currentUserApi)
    {
        ...
        $logArgs = ['app' => 'ZikulaMultisitesModule', 'user' => $currentUserApi->get('uname'), 'entities' => 'templates', 'userid' => $userId];
