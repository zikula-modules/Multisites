...
abstract class AbstractTemplateRepository extends EntityRepository
{
     ...
     */
    protected $mainEntityClass = 'Zikula\MultisitesModule\Entity\TemplateEntity';
    ...
    public function selectSearch($fragment = '', array $exclude = [], $orderBy = '', $currentPage = 1, $resultsPerPage = 25, $useJoins = true)
    {
        ...
        if (null !== $this->collectionFilterHelper) {
            $qb = $this->collectionFilterHelper->addSearchFilter('template', $qb, $fragment);
        }
    ...
    public function selectCount($where = '', $useJoins = false, array $parameters = [])
    {
        ...
        if (null !== $this->collectionFilterHelper) {
            $qb = $this->collectionFilterHelper->applyDefaultFilters('template', $qb, $parameters);
        }
     ...
     * @param integer $excludeId  Id of templates to exclude (optional)
     *
