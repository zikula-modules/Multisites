 ...
 *
 * This is the base factory class for site entities.
 */
abstract class AbstractSiteFactory
{
    /**
     * @var String Full qualified class name to be used for sites.
     */
    protected $className;
     ...
     * @param String        $className Full qualified class name to be used for sites
     */
