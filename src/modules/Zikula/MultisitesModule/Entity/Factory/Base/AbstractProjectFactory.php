 ...
 *
 * This is the base factory class for project entities.
 */
abstract class AbstractProjectFactory
{
    /**
     * @var String Full qualified class name to be used for projects.
     */
    protected $className;
     ...
     * @param String        $className Full qualified class name to be used for projects
     */
