 ...
 *
 * This is the base factory class for template entities.
 */
class TemplateFactory
{
    /**
     * @var String Full qualified class name to be used for templates.
     */
    protected $className;
     ...
     * @param String        $className Full qualified class name to be used for templates.
     */
