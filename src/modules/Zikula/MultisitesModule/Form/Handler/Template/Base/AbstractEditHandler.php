...
abstract class AbstractEditHandler extends EditHandler
{
    ...
    public function processForm(array $templateParameters)
    {
        ...
        if (!empty($this->relationPresets['projects'])) {
            $relObj = $selectionHelper->getEntity('project', $this->relationPresets['projects']);
            if (null !== $relObj) {
    ...
    public function applyAction(array $args = [])
    {
        ...
        try {
            ...
            $logArgs = ['app' => 'ZikulaMultisitesModule', 'user' => $this->container->get('zikula_users_module.current_user')->get('uname'), 'entity' => 'template', 'id' => $entity->createCompositeIdentifier(), 'errorMessage' => $e->getMessage()];
