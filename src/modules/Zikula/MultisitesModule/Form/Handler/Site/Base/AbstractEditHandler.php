...
abstract class AbstractEditHandler extends EditHandler
{
    ...
    public function processForm(array $templateParameters)
    {
        ...
        if (!empty($this->relationPresets['template'])) {
            $relObj = $selectionHelper->getEntity('template', $this->relationPresets['template']);
            if (null !== $relObj) {
        ...
        if (!empty($this->relationPresets['project'])) {
            $relObj = $selectionHelper->getEntity('project', $this->relationPresets['project']);
            if (null !== $relObj) {
                $relObj->addSites($entity);
            }
        }
    ...
    public function applyAction(array $args = [])
    {
        ...
        try {
            ...
            $logArgs = ['app' => 'ZikulaMultisitesModule', 'user' => $this->container->get('zikula_users_module.current_user')->get('uname'), 'entity' => 'site', 'id' => $entity->createCompositeIdentifier(), 'errorMessage' => $e->getMessage()];
    ...
    protected function getRedirectUrl($args)
    {
        ...
        switch ($this->returnTo) {
            ...
            case 'userViewTemplate':
                return $this->router->generate('zikulamultisitesmodule_template_view');
            case 'adminViewProject':
                return $this->router->generate('zikulamultisitesmodule_project_adminview');
            case 'userViewProject':
                return $this->router->generate('zikulamultisitesmodule_project_view');
            default:
                return $this->getDefaultReturnUrl($args);
        }
    }
