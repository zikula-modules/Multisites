...
abstract class AbstractEditHandler extends EditHandler
{
    ...
    protected function getFormOptions()
    {
        $options = [
            ...
            'allow_moderation_specific_creator' => $this->variableApi->get('ZikulaMultisitesModule', 'allowModerationSpecificCreatorFor' . $this->objectTypeCapital),
            'allow_moderation_specific_creation_date' => $this->variableApi->get('ZikulaMultisitesModule', 'allowModerationSpecificCreationDateFor' . $this->objectTypeCapital),
