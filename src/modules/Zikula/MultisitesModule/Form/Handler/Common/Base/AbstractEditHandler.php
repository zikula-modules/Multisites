...
abstract class AbstractEditHandler
{
     ...
     */
    public function __construct(ContainerBuilder $container, TranslatorInterface $translator, RequestStack $requestStack, RouterInterface $router, UploadHandler $uploadHandler)
    {
