...
abstract class AbstractTemplateController extends AbstractController
{
    ...
    protected function viewInternal(Request $request, $sort, $sortdir, $pos, $num, $isAdmin = false)
    {
        ...
        $filteredEntities = [];
        foreach ($templateParameters['items'] as $template) {
            if (!$this->hasPermission('ZikulaMultisitesModule:' . ucfirst($objectType) . ':', $template->getKey() . '::', $permLevel)) {
                continue;
            }
            $filteredEntities[] = $template;
        }
