...
class AjaxController extends AbstractController
{
    ...
    public function toggleFlagAction(Request $request)
    {
        ...
        $entity = ModUtil::apiFunc($this->name, 'selection', 'getEntity', ['ot' => $objectType, 'id' => $id]);
        if ($entity == null) {
        ...
        $logger->notice('{app}: User {user} toggled the {field} flag the {entity} with id {id}.', ['app' => 'ZikulaMultisitesModule', 'user' => UserUtil::getVar('uname'), 'field' => $field, 'entity' => $objectType, 'id' => $id]);
