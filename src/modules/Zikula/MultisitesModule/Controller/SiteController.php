...
class SiteController extends BaseSiteController
{
    ...
    public function handleSelectedEntriesAction(Request $request)
    {
        ...
        foreach ($items as $itemid) {
            ...
            if ($entity === false || !is_object($entity)) {
                $this->addFlash(\Zikula_Session::MESSAGE_ERROR, $this->__f('Error! No site with id %s could be found.', [DataUtil::formatForDisplay($itemid)]));
                continue;
            }
            ...
            switch ($action) {
                case 'cleartemplates':
                    ...
                    $siteTempDirectory = $siteBasePath . '/' . $instance['sitedns'] . '/' . $serviceManager['multisites.site_temp_files_folder'];
    ...
    protected function manageExtensionsInternal(Request $request, $isAdmin = false)
    {
        ...
        return $viewHelper->processTemplate($this->get('twig'), $objectType, 'manageExtensions', $request, $templateParameters);
    }
    ...
    protected function manageThemesInternal(Request $request, $isAdmin = false)
    {
        ...
        return $viewHelper->processTemplate($this->get('twig'), $objectType, 'manageThemes', $request, $templateParameters);
    }
    ...
    protected function viewToolsInternal(Request $request, $isAdmin = false)
    {
        ...
        return $viewHelper->processTemplate($this->get('twig'), $objectType, 'viewTools', $request, $templateParameters);
    }
    ...
    protected function loadCurrentSite()
    {
        ...
        $idValues = $controllerHelper->retrieveIdentifier($this->request, [], $objectType, $idFields);
