...
class MultisitesExtensionsListener implements EventSubscriberInterface
{
    ...
    public function remove(GenericEvent $event)
    {
        ...
        $states = [
            ExtensionsConstant::STATE_NOTALLOWED,
            ExtensionsConstant::STATE_MISSING,
            ExtensionsConstant::STATE_INVALID
        ];
        $currentState = $event->getSubject()->getState();
        if (in_array($currentState, $states, true)) {
            return;
        }
    ...
    private function isAllowed()
    {
        ...
        if (
            ($this->multisitesParameters['mainsiteurl'] == $request->query->get('sitedns', null)
