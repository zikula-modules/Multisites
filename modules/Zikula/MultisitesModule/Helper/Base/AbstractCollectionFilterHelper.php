...
abstract class AbstractCollectionFilterHelper
{
    ...
    protected function applyDefaultFiltersForSite(QueryBuilder $qb, array $parameters = [])
    {
        ...
        $routeName = $request->get('_route', '');
        $isAdminArea = false !== mb_strpos($routeName, 'zikulamultisitesmodule_site_admin');
        if ($isAdminArea) {
            return $qb;
        }
    ...
    protected function applyDefaultFiltersForTemplate(QueryBuilder $qb, array $parameters = [])
    {
        ...
        $routeName = $request->get('_route', '');
        $isAdminArea = false !== mb_strpos($routeName, 'zikulamultisitesmodule_template_admin');
        if ($isAdminArea) {
            return $qb;
        }
    ...
    protected function applyDefaultFiltersForProject(QueryBuilder $qb, array $parameters = [])
    {
        ...
        $routeName = $request->get('_route', '');
        $isAdminArea = false !== mb_strpos($routeName, 'zikulamultisitesmodule_project_admin');
        if ($isAdminArea) {
            return $qb;
        }
