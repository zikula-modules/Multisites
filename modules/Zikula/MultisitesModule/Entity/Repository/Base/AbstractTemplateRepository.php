...
abstract class AbstractTemplateRepository extends EntityRepository
{
     ...
     */
    protected $mainEntityClass = TemplateEntity::class;
     ...
     * @param bool $slimMode If activated only some basic fields are selected without using any joins (optional) (default=false)
     *
     * @return array Retrieved TemplateEntity instances
     */
     ...
     * @param bool $slimMode If activated only some basic fields are selected without using any joins (optional) (default=false)
     *
     * @return array List of retrieved templateEntity instances
     */
     ...
     * @param int $excludeId Identifier of templates to exclude (optional)
     *
     * @return bool Result of this check, true if the given template does not already exist
     */
