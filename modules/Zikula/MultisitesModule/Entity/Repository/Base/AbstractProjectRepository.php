...
abstract class AbstractProjectRepository extends EntityRepository
{
     ...
     */
    protected $mainEntityClass = ProjectEntity::class;
    ...
    public function selectByIdList(
        ...
        if (!$slimMode && null !== $this->collectionFilterHelper) {
            $qb = $this->collectionFilterHelper->applyDefaultFilters('project', $qb);
        }
    ...
    public function selectSearch(
        ...
        if (null !== $this->collectionFilterHelper) {
            $qb = $this->collectionFilterHelper->addSearchFilter('project', $qb, $fragment);
        }
    ...
    public function selectCount($where = '', $useJoins = false, array $parameters = [])
    {
        ...
        if (null !== $this->collectionFilterHelper) {
            $qb = $this->collectionFilterHelper->applyDefaultFilters('project', $qb, $parameters);
        }
     ...
     * @param int $excludeId Identifier of projects to exclude (optional)
     *
     * @return bool Result of this check, true if the given project does not already exist
     */
