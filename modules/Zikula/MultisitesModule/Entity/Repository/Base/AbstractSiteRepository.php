...
abstract class AbstractSiteRepository extends EntityRepository
{
     ...
     */
    protected $mainEntityClass = SiteEntity::class;
     ...
     *                       (optional) (default=false)
     *
     * @return array Retrieved SiteEntity instances
     */
     ...
     *                       (optional) (default=false)
     *
     * @return array List of retrieved siteEntity instances
     */
    ...
    public function selectSearch(
        ...
        if (null !== $this->collectionFilterHelper) {
            $qb = $this->collectionFilterHelper->addSearchFilter('site', $qb, $fragment);
        }
    ...
    public function selectCount($where = '', $useJoins = false, array $parameters = [])
    {
        ...
        if (null !== $this->collectionFilterHelper) {
            $qb = $this->collectionFilterHelper->applyDefaultFilters('site', $qb, $parameters);
        }
     ...
     * @param int $excludeId Identifier of sites to exclude (optional)
     *
     * @return bool Result of this check, true if the given site does not already exist
     */
